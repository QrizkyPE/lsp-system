                ...
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column">
                        @if(auth()->user()->role === 'admin')
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('admin.surat-pernyataan-kesediaan*') ? 'active' : '' }}" href="{{ route('admin.surat-pernyataan-kesediaan.index') }}">
                                    <i class="fas fa-file-signature me-2"></i>Surat Pernyataan Kesediaan
                                </a>
                            </li>
                        ...
                        @elseif(auth()->user()->role === 'asesor')
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('asesor.daftar-hadir-peserta*') ? 'active' : '' }}" href="{{ route('asesor.daftar-hadir-peserta.index') }}">
                                    <i class="fas fa-users me-2"></i>Daftar Hadir Peserta
                                </a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('asesor.surat-pernyataan-kesediaan*') ? 'active' : '' }}" href="{{ route('asesor.surat-pernyataan-kesediaan.index') }}">
                                    <i class="fas fa-file-signature me-2"></i>Surat Pernyataan Kesediaan
                                </a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('mahasiswa.observasi-checklist*') ? 'active' : '' }}" href="{{ route('mahasiswa.observasi-checklist') }}">
                                    ...
                                    @if(isset($pendingObservasiCount) && $pendingObservasiCount > 0)
                                        <span class="badge bg-danger rounded-pill ms-2">{{ $pendingObservasiCount }}</span>
                                    @endif
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('mahasiswa.penyesuaian-checklist*') ? 'active' : '' }}" href="{{ route('mahasiswa.penyesuaian-checklist') }}">
                                    ...
                                    @if(isset($pendingPenyesuaianCount) && $pendingPenyesuaianCount > 0)
                                        <span class="badge bg-danger rounded-pill ms-2">{{ $pendingPenyesuaianCount }}</span>
                                    @endif
                                </a>
                            </li>
                            <li class="nav-item">
