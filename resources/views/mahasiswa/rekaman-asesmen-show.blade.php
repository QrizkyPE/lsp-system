            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('mahasiswa.rekaman-asesmen') }}" class="btn btn-secondary">
                            <i class="fas fa-arrow-left me-1"></i>
                            Kembali
                        </a>
                        @if(!$rekamanAsesmen->mahasiswa_signature)
                            <a href="{{ route('mahasiswa.rekaman-asesmen.signature', $rekamanAsesmen->id) }}" class="btn btn-primary">
