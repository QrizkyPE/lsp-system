        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('mahasiswa.banding-asesmen.select-rekaman') }}" class="btn btn-light btn-sm">
                        <i class="fas fa-plus me-1"></i>Buat Banding Baru
                    </a>
                </div>
                <div class="card-body">
                    @if(session('success'))
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <p class="text-muted">Anda belum pernah mengajukan banding asesmen.</p>
                        </div>
                    @endif
                </div>
            </div>
