    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2><i class="fas fa-file-alt me-2"></i>Detail Pendaftaran - Asesmen Mandiri</h2>
                <a href="{{ route('asesor.asesmen') }}" class="btn btn-secondary">
                    <i class="fas fa-arrow-left"></i> Kembali ke Asesmen
                </a>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-4">
                                <h6><i class="fas fa-table me-2"></i>Tabel Hasil Asesmen Mandiri</h6>
                                @php
                                    // Reset global counter for this pendaftaran (same as modal)
                                ...
                                @foreach($unitKompetensiJudul as $unit)
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body">
                                            ...
                                            @php
                                                $elemenForUnit = $elemenJudul->where('kode_unit', $unit->kode_unit);
                                            @endphp
                                            ...
                                            @if($elemenForUnit->count() > 0)
                                                @foreach($elemenForUnit as $elemen)
                                                    <div class="mb-3">
                                                        ...
                                                        @php
                                                            $kriteriaForElemen = $kriteriaJudul->where('kode_elemen', $elemen->kode_elemen);
                                                        @endphp
                                                                    ...
                                                                    <tbody>
                                                                        @foreach($kriteriaForElemen as $kriteria)
                                                                            @php
                                                                                ...
                                                                                // Check if asesmenData exists and has the mapped key
