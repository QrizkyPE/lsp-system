                ...
                <div class="card-body">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <a href="{{ route('asesor.daftar-hadir-asesor.edit', $item->id) }}" 
                                                       class="btn btn-warning btn-sm" title="Edit">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <a href="{{ route('asesor.daftar-hadir-asesor.pdf', $item->id) }}" 
                                    ...
                                    @foreach($jadwalsWithoutDaftarHadir as $jadwal)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('asesor.daftar-hadir-asesor.create', $jadwal->id) }}" 
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <p class="text-muted">Anda belum memiliki jadwal uji yang ditugaskan untuk membuat daftar hadir asesor.</p>
                        </div>
                    @endif
                </div>
            </div>
