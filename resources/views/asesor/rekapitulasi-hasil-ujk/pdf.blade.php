...
<body>
    ...
    <table class="bordered" style="height: 100px;">
        <tr>
        ...
        <tr>
            ...
            <td class="p-8" style="width: 20%;">{{ $rekapitulasi->no_dokumen ?? '-' }}</td>
        ...
        <tr>
            ...
            <td class="p-8">{{ $rekapitulasi->edisi_revisi ?? '-' }}</td>
    ...
    <div class="info-container" style="margin-top: 6px; margin-bottom: 15px;">
        <div class="info-left">
            <p style="font-size: 12px; margin: 5px 0;">Skema&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{ $rekapitulasi->skema ?? '-' }}</p>
            <p style="font-size: 12px; margin: 5px 0;">Hari/Tanggal&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{ $hariTanggalWithDay }}</p>
            
            <p style="font-size: 12px; margin: 5px 0;">TUK&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{ $rekapitulasi->tuk->nama_tuk ?? ($rekapitulasi->jadwalUji->tuk->nama_tuk ?? '-') }}</p>
        </div>
        ...
        <tbody>
            @foreach($asesiList as $index => $asesi)
                <tr>
                    ...
                    <td class="p-8">{{ $asesi['nama'] }}</td>
                    <td class="p-8">{{ $asesi['npm'] }}</td>
                    <td class="p-8 text-center">
                        @if($asesi['k'])
                            <div style="width: 16px; height: 16px; border: 2px solid #000; margin: 0 auto; position: relative; display: inline-block;">
                                <svg width="16" height="16" style="position: absolute; top: -2px; left: -2px;">
                                    <path d="M 2 8 L 6 12 L 14 4" stroke="#000" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </div>
                        @else
                            <div style="width: 16px; height: 16px; border: 2px solid #000; margin: 0 auto; display: inline-block;"></div>
                        @endif
                    </td>
                    <td class="p-8 text-center">
                        @if($asesi['bk'])
