        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @if($rekapitulasi->count() > 0 || $jadwalsWithoutRekapitulasi->count() > 0)
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <a href="{{ route('asesor.rekapitulasi-hasil-ujk.edit', $item->id) }}" 
                                                       class="btn btn-warning btn-sm" title="Edit">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <a href="{{ route('asesor.rekapitulasi-hasil-ujk.pdf', $item->id) }}" 
                                    ...
                                    {{-- Jadwals without rekapitulasi --}}
                                    @foreach($jadwalsWithoutRekapitulasi as $jadwal)
                                        <tr>
                                            <td class="text-center">{{ $no++ }}</td>
                                            ...
                                            <td>
                                                <a href="{{ route('asesor.rekapitulasi-hasil-ujk.create', $jadwal->id) }}" 
                                                   class="btn btn-primary btn-sm" title="Buat Rekapitulasi">
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <p class="text-muted">Anda belum memiliki jadwal uji yang ditugaskan untuk membuat rekapitulasi hasil UJK.</p>
                        </div>
                    @endif
                </div>
            </div>
