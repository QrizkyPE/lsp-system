    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('asesor.laporan-asesmen.store', $jadwal->id) }}" method="POST">
                        @csrf
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="date" name="tanggal" class="form-control"
                                                       value="{{ ($jadwal->tanggal_mulai ?? now())->format('Y-m-d') }}">
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="aspek_positif_negatif" class="form-control" rows="3"></textarea>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label"><strong>Pencatatan Penolakan Hasil Asesmen</strong></label>
                                    <textarea name="penolakan_hasil" class="form-control" rows="3"></textarea>
                                </div>
                                <div class="mb-3">
...
// Opsional: pastikan K dan BK tidak sama-sama tercentang untuk satu asesi
