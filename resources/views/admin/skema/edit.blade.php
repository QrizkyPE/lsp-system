...
<div class="card shadow">
    <div class="card-header">
        <h5 class="mb-0">Form Edit Skema Sertifikasi</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.skema.update', $skema) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('kode_skema') is-invalid @enderror" 
                           id="kode_skema" name="kode_skema" value="{{ old('kode_skema', $skema->kode_skema) }}" required>
                    @error('kode_skema')
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('nama_skema') is-invalid @enderror" 
                           id="nama_skema" name="nama_skema" value="{{ old('nama_skema', $skema->nama_skema) }}" required>
                    @error('nama_skema')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select @error('level_kompetensi') is-invalid @enderror" 
                        ...
                        <option value="Level 1" {{ old('level_kompetensi', $skema->level_kompetensi) == 'Level 1' ? 'selected' : '' }}>Level 1</option>
                        <option value="Level 2" {{ old('level_kompetensi', $skema->level_kompetensi) == 'Level 2' ? 'selected' : '' }}>Level 2</option>
                        <option value="Level 3" {{ old('level_kompetensi', $skema->level_kompetensi) == 'Level 3' ? 'selected' : '' }}>Level 3</option>
                        <option value="Level 4" {{ old('level_kompetensi', $skema->level_kompetensi) == 'Level 4' ? 'selected' : '' }}>Level 4</option>
                        <option value="Level 5" {{ old('level_kompetensi', $skema->level_kompetensi) == 'Level 5' ? 'selected' : '' }}>Level 5</option>
                    </select>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select @error('status') is-invalid @enderror" 
                        ...
                        <option value="1" {{ old('status', $skema->status) == '1' ? 'selected' : '' }}>Aktif</option>
                        <option value="0" {{ old('status', $skema->status) == '0' ? 'selected' : '' }}>Tidak Aktif</option>
                    </select>
                    @error('status')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('deskripsi') is-invalid @enderror" 
                          id="deskripsi" name="deskripsi" rows="4" required>{{ old('deskripsi', $skema->deskripsi) }}</textarea>
                @error('deskripsi')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('standar_kompetensi') is-invalid @enderror" 
                          id="standar_kompetensi" name="standar_kompetensi" rows="4" required>{{ old('standar_kompetensi', $skema->standar_kompetensi) }}</textarea>
